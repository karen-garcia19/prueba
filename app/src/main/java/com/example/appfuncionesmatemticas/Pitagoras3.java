...
public class Pitagoras3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lado1 = (EditText)findViewById(R.id.y_ingresaC1);
        lado2 = (EditText)findViewById(R.id.y_ingresaA1);
        resultado1 = (TextView)findViewById(R.id.txt_resultado33);
    }
