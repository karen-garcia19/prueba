...
public class Caso2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ladob = (EditText)findViewById(R.id.ladob2);
        ladoc = (EditText)findViewById(R.id.ladoC2);
        Senb = (EditText)findViewById(R.id.senB2);
        Senc = (EditText)findViewById(R.id.Senc2);
        res = (TextView)findViewById(R.id.hula1234);
    }
    //Este metodo realiza el seno
    public void seno1(View view) {

        if (ladob.length() == 0){
            String valor2 = ladoc.getText().toString();
            String valor3 = Senb.getText().toString();
        ...
        if (ladoc.length() == 0){
            String valor1 = ladob.getText().toString();
            String valor3 = Senb.getText().toString();
            String valor4 = Senc.getText().toString();
